...
module Compiler
  class PlayProcessor < TemplateProcessor
    ...
    @@yield_hash = {
      ...
      html_lang: '@htmlLang.getOrElse("en-GB")',
      # NOTE: the mismatch between page_title and @title
      page_title: '@title.getOrElse("Exporting is GREAT")',
      ...
      top_of_page: '@(title: Option[String], bodyClasses: Option[String], htmlLang: Option[String] = None)(head:Html, bodyStart:Html, bodyEnd:Html, insideHeader:Html, afterHeader:Html, footerTop:Html, footerLinks:Html, headerClass:Html = Html.empty, homepageUrl:Html = Html.empty, skipLinkMessage:Html, logoLinkTitle:Html)(content:Html)',
      head: '@head',
      ...
      homepage_url: '@homepageUrl.getOrElse("https://www.exportingisgreat.gov.uk/")',
      skip_link_message: '@skipLinkMessage.getOrElse("Skip to main content")',
      logo_link_title: '@logoLinkTitle.getOrElse("Go to the Exporting is GREAT homepage")',
    }
